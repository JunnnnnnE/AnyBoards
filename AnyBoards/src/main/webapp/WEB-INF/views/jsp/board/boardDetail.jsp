        ...
        <div id="contents_detail">
            ...
            <!-- Category -->
                <ul id="contents_category">
                    ...
                    <c:if test="${boardDetail.get(0).board_group_no eq '2'}">
						<li><a href="/any/board?board_group_no=2" class="select">Q&amp;A</a></li>
                    </c:if>
                    
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=html">#HTML</a></li>
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=css">#CSS</a></li>
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=js">#JS</a></li>
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=java">#Java</a></li>
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=c language">#C Language</a></li>
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=python">#Python</a></li>
                    <li><a href="/any/board?board_group_no=${board_group_no}&board_tag_name=sql">#SQL</a></li>
                </ul>
                <!-- Board -->
                <div id="board_list">
                    <!-- Title -->
	                    ...
	                    <div id="board_list_row">
	                        <div class="row">
	                            <div class="row_info">
	                                ...
	                                <div class="row_top member">
											...
											<c:choose>
												...
												<c:otherwise>
													<span class="rank" style="color: #111;">[anyCoder]</span>
												</c:otherwise>
											</c:choose>
	                            ...
	                            <ul class="row_top number">
	                                ...
	                                <li><img src="/any/resources/images/icon/icon_comment.svg" class="i_cmt">${boardDetail.board_comment_count}</li>
	                                <li><img src="/any/resources/images/icon/icon_like.svg" class="i_like">${boardDetail.board_like_count}</li>
	                            </ul>
...
<!-- ***************************************************************************************************************************************************** -->		                            
		                            <ul class="row_top number">
		                            	<c:forEach items="${answerCount}" var="answerCount">
		                            		<c:if test="${status.index+1 eq answerCount.ref_step}">
	                                    		<li><img src="/any/resources/images/icon/icon_comment.svg" class="i_cmt">${answerCount.board_answer_count-1}</li>
	                                    		<li><img src="/any/resources/images/icon/icon_like.svg" class="i_like">${boardComment.bcomment_like_count}</li>
	                                    	</c:if>
	                                    </c:forEach>
	                                </ul>
	                                <div class="btn_group">
			                	...
			                	<div id="comment_list-${boardAnswer.ref_step}-${boardAnswer.ref_level}" class="answer_list-${boardComment.ref_step}-${boardComment.ref_level}" style="display : none;" >
				                	<div class="comment_box answer_box">
				                		<div class="row">
				                            ...
				                            <ul class="row_top number">
			                                    <li><img src="/any/resources/images/icon/icon_comment.svg" class="i_cmt">0</li>
			                                    <li><img src="/any/resources/images/icon/icon_like.svg" class="i_like">${boardAnswer.bcomment_like_count}</li>
			                                </ul>
			                                <div class="btn_group">
   ...
   $(document).ready(function () {
        ...
        if(reportval>0) {
            console.log(report);
            $("#report").prop("src", "/any/resources/images/icon/siren-fill.png");
            $(".report").prop('name',reportval)
        }
        else {
            console.log(report);
            $("#report").prop("src", "/any/resources/images/icon/siren.png");
            $(".report").prop('name',reportval)
        }
    });
  ...
  $('#drop-button2').on("click",function(e){
		...
		let popUrl = "/any/chatMainList?nick="+nick;
